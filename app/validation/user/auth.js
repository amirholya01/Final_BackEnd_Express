/**
 * Validates user registration data using Express-validator.
 * @module RegisterValidator
 * @requires express-validator/body
 * @requires UserModel
 */
...
// Export the registerValidator function and the loginValidator function
module.exports = {
    registerValidator,
    loginValidator
};
